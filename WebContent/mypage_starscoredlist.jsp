...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	arrForMovieInfo = starScoreHandler.connectJspToDBConnectorToGetMovieCdAndScoreFromStarScoreTable(request, response);
            ...
            <section class="mid2">
                <header class="midheader">
                    <div class="backblank">
                        ...
                        <div class="want">
                            <div class="wantsee">내가 평가한 영화</div>
                        </div>
                    </div>
        
                    <div class="wannasee">내가 평가한 영화</div>
                </header>
                                ...
                                <li class="movietitle">
                                    <a lang="ko=KR" title="<%=arrForMovieInfo.get(i).getMovieNm() %>" href="javascript:moreInfo('<%=arrForMovieInfo.get(i).getMovieCd()%>')">
                                        ...
                                        <div class="titlebox">
                                            ...
                                            <div class="starrate">나의 평점 : <%=arrForMovieInfo.get(i).getStarScore()%></div>
                                        </div>
                                    </a>
                                </li>
